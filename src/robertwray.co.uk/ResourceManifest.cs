...
namespace robertwraycouk
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(ResourceManifestBuilder builder)
        {
            ...
            manifest.DefineScript("Bootstrap").SetUrl("https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js").SetVersion("3.3.4").SetDependencies("jQuery", "popper");
